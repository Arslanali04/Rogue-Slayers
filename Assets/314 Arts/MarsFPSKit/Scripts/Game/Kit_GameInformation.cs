...
namespace MarsFPSKit
{
    ...
    public class Kit_GameInformation : ScriptableObject
    {
        ...
        [Tooltip(" If set to true, shots will be fired locally instead of receiving the hit result via RPC")]
        /// <summary>
        /// If set to true, shots will be fired locally instead of receiving the "hit" result via RPC
        /// </summary>
        public bool fireShotsLocally = true;
