...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                // Character selection and other logic here...

                // [The rest of your LateUpdate code remains unchanged]
                // For brevity, I'm focusing on the fix you requested.
            }
            else
            {
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // UVS2 - also Vector4 arrays
           // Vector4[] src_uv2s = m_cachedMeshInfoVertexData[materialIndex].uvs2;
           // Vector4[] dst_uv2s = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs2;
